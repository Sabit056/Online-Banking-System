...
public class App {
    public static void main(String[] args) {
        ...
        String greeting = "-----Welcome to Online Banking System-----\r\n" +
                                "-------------------------------------------\r\n" +
                                "1. ACCOUNTANT Login \r\n" +
                                "2. CUSTOMER Login \r\n" +
                                "0. Sign Out \r\n";
        String accountantOptions = "-----------------Choose Option-----------------\r\n"+
                                    ...
                                    "0. Logout";
        String customerOptions = "-----------------Choose Option-----------------\r\n" +
                                    "1. View Balance \r\n" +
                                    "2. Deposit Money \r\n" +
                                    "3. Withdraw Money \r\n" +
                                    "4. Transfer Money \r\n" +
            ...
            switch (option) {
                case 1:
                    ...
                    try {
                        ...
                        while (y) {
                            System.out.println(accountantOptions);
                            System.out.print("Select your option : ");
                            ...
                            if (x == 1) {
                                ...
                                int s1 = -1;
                                try {
                                    s1 = ad.addCustomer(customerName.toLowerCase(), customerEmail, customerAddress, customerContact, customerPassword, customerBalance);
